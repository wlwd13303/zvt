...
| 报表简称 | 英文简称 | 报表简介                                   | 数据类 |      |
| -------- | -------- | ------------------------------------------ | ------ | ---- |
| 个股资料 | stock    | 个股简单基础数据，支持沪深股票、港股、美股 | Stock  |      |
...
| 简称     | 英文简称                                                     | 简介                                                         | 数据类            |      |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ----------------- | ---- |
| 个股行情 | stock_1d_kdata、（前复权）stock_1d_hfq_kdata、（后复权）stock_1d_bfq_kdata、（不复权） | 个股行情数据，支持1日线，周线，月线级别，支持沪深股票，港股，美股 | Stock{level}Kdata |      |
